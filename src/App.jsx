...
const LANGS = {
  en: {
    ...
    sectors: [
      ...
      },
      {
        ...
        desc: "PLC/SCADA configuration, control panels, HMI programming and system integrations.",
        img: "img_automation",
      },
    ],
    why_label: "Why ANC",
  ...
  es: {
    ...
    sectors: [
      ...
      {
        num: "04",
        title: "Eléctrica & Automatización",
        desc: "Configuración PLC/SCADA, tableros de control, programación HMI e integraciones de sistemas.",
        img: "img_automation",
      },
    ],
  ...
  it: {
    ...
    sectors: [
      ...
      {
        num: "04",
        title: "Elettrica & Automazione",
        desc: "Configurazione PLC/SCADA, quadri di comando, HMI e integrazioni di sistema.",
        img: "img_automation",
      },
    ],
